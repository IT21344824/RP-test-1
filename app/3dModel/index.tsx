...
import SandakadaPahana from "@/components/3dModel/SandakadaPahana";
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        <Text style={styles.text}>
          This is an elaborately carved semi-circular stone slab,
          usually placed at the bottom of staircases and entrances.
        </Text>
      </View>
      <View style={styles.modelContainer} {...events}>
        ...
        <Canvas>
          ...
          <directionalLight position={[0, 0, 1]} args={["white", 2]} />
          <directionalLight position={[0, 0, -1]} args={["white", 2]} />
          <directionalLight position={[1, 0, 0]} args={["white", 15]} />
          <directionalLight position={[1, 0, 0]} args={["white", 2]} />
